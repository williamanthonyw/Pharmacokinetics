...
const About = () => {
  return (
    <div className='container'>
      ...
      <p>
        In addition to these equations provided, the website also includes interactive graphs that will allow students to actively engage with pharmacokinetic equations in real time.
      </p>
      <p>
